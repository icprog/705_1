...
/*设备其它参数和数据存储位置*/
#define ADDR_DF_PARAM_BASE 			0x041000				///用来存储设备非主要参数和用户数据等信息
...
#define ADDR_DF_POSTREPORT_END		0x310000				///gps补报数据存储区域结束位置
#define ADDR_DF_POSTREPORT_SECT		100						///扇区总数量

/*gps压缩数据存储区域*/
//正常1秒 517字节  压缩后 260
//近似 100个扇区 保存25分钟原始数据
#define ADDR_DF_GPS_PACK_START		0x310000				///gps原始压缩数据存储区域开始位置
#define ADDR_DF_GPS_PACK_SECT		100						///扇区总数量
