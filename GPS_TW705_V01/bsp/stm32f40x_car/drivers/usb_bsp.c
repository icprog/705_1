...
/**
  * @brief  BSP_SetTime
  *         Configures TIM4 for delay routine based on TIM4
...
static void BSP_SetTime(uint8_t unit)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM4,ENABLE);			///2013.11.1新增加的部分，同时将TIM2修改为TIM4
  TIM_Cmd(TIM4,DISABLE);
